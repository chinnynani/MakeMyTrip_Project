...
import com.elementRepository.BookingPage;
import com.elementRepository.DetailsPage;
...
public class MakeMyTrip {
	...
	public void browser_should_be_launched_and_url_should_be_navigated_and_pop_up_handled() throws Exception {
		...
		String url = fileUtility.getDataFromExcel("DATA", 0, 0);
	...
	public void user_should_be_able_to_click_on_homestays_and_villas_link() throws Exception {
		String title = fileUtility.getDataFromExcel("DATA", 2, 0);
	...
	public void user_should_be_navigated_to_homestays_and_villas_page() throws Exception {
		String url = fileUtility.getDataFromExcel("DATA", 1, 0);
		Assert.assertEquals(driver.getCurrentUrl(), url);
	...
	public void user_should_be_able_to_enter_city_name_and_select_the_city_name() throws Exception {
		...
		String city = fileUtility.getDataFromExcel("City", 0, 0);
		cityname.sendKeys(city);
		fileUtility.thread();
		cityname.sendKeys(Keys.ARROW_DOWN + "" + Keys.ENTER);
		Reporter.log("User selected the city name", true);
	}
	...
	public void user_should_be_able_to_click_on_the_check_in_and_select_the_date() throws Exception {
		String month = fileUtility.getDataFromExcel("Dates", 0, 0);
		int date = fileUtility.getNumericalDataFromExcel("Dates", 0, 1);
	...
	public void user_should_be_able_to_click_on_the_check_out_and_select_the_date() throws Exception {
		String month = fileUtility.getDataFromExcel("Dates", 1, 0);
		int date = fileUtility.getNumericalDataFromExcel("Dates", 1, 1);
	...
	public void user_should_be_able_to_click_on_the_guests_and_select_no_of_guests() throws InterruptedException {
		...
		Reporter.log("User is Selected the Guests Count", true);
	}
	...
	public void user_is_able_to_click_on_the_search_button() throws Exception {
		...
		String title = fileUtility.getDataFromExcel("DATA", 3, 0);
		fileUtility.thread();
	...
	public void user_is_able_to_choose_indian_rupee_option() throws Exception {
		...
		String currencyType = fileUtility.getDataFromExcel("Currency", 0, 0);
	...
	public void user_is_able_to_change_the_date_and_click_on_apply() throws Exception {
		int date = fileUtility.getNumericalDataFromExcel("Dates", 2, 1);
	...
	public void selecting_should_be_displayed(Integer SortOption) throws Exception {
		...
		String sortoption = fileUtility.getDataFromExcel("SortBy", SortOption-1, 0);
	...
	public void close_the_map() {
		...
		WebElement returnBack = propertyPage.getReturnBack();
		Assert.assertTrue(returnBack.isDisplayed(), "Map not Closed");
...
//		propertyPage.clickElement(propertyPage.getProperty());
		detailsPage=propertyPage.goToDetailsPage(driver);
		fileUtility.thread();
		Reporter.log("User is selected the filters",true);
	}

	@Then("User is able to navigate to the property")
	public void user_is_able_to_navigate_to_the_property() {
		String expectedTitle=detailsPage.expected_Title();
		String actualTitle=detailsPage.expected_Title();		
	...
	public void user_is_able_to_click_on_the_property() throws InterruptedException {
		bookingPage=propertyPage.goToBookingPage(driver);
		fileUtility.thread();
	...
	public void user_is_able_to_navigate_to_the_next_page() {
		String expectedTitle=bookingPage.expected_Title();
		String actualTitle=bookingPage.expected_Title();		
		Assert.assertEquals(actualTitle, expectedTitle);
